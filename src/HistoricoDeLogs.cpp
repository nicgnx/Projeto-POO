...
void HistoricoDeLogs::printLog(
    ...
    switch (log) {
        case Escrita: {
            vector<LogEscrita*> logsE =
                listaLogEscrita(idUsuario, inicial, final);
        ...
        case Excecao: {
            vector<LogExcecao*> logsEx =
                listaLogExcecao(idUsuario, inicial, final);
        ...
        case Leitura: {
            vector<LogLeitura*> logsL =
                listaLogLeitura(idUsuario, inicial, final);
