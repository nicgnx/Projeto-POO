...
// Getters
double Salario::getSalarioBase() { return this->salarioBase; }
double Salario::getVariacaoSalarial() { return this->variacaoSalarial; }
Data Salario::getData() { return this->data; }
Motivo Salario::getMotivacao() { return this->motivacao; }
