...
to_string(this->idProduto),"getNome");
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"Produto",to_string(this->idProduto),"nome"));
...
to_string(this->idProduto),"getIdProduto");
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"Produto",to_string(this->idProduto),"idProduto"));
...
to_string(this->idProduto),"getMateriasPrimas");
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"Produto",to_string(this->idProduto),"materiasPrimas"));
...
to_string(this->idProduto),"getPrecos");
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"Produto",to_string(this->idProduto),"precos"));
...
to_string(this->idProduto),"getCategoria");
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"Produto",to_string(this->idProduto),"categoria"));
...
to_string(this->idProduto),"getLoteMinimo");
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"Produto",to_string(this->idProduto),"loteMinimo"));
...
to_string(this->idProduto),"getEstoqueMinimo");
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"Produto",to_string(this->idProduto),"estoqueMinimo"));
