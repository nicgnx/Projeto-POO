...
int MateriaPrima::getId() { 
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"MateriaPrima",to_string(this->id),"id"));
...
std::string MateriaPrima::getNome() { 
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"MateriaPrima",to_string(this->id),"nome"));
...
std::string MateriaPrima::getUnidade() { 
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"MateriaPrima",to_string(this->id),"unidade"));
...
int MateriaPrima::getEstoqueMinimo() { 
  ...
  Login* login = Login::getInstance();
  HistoricoDeLogs* historic = HistoricoDeLogs::getInstancia();
  historic->setLog(new LogLeitura(login->getUsuario()->getNome(),login->getUsuario()->getcpfCnpj(),Data().dateNow(),"MateriaPrima",to_string(this->id),"estoqueMinimo"));
