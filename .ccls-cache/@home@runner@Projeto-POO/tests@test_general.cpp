...
/*TEST_CASE("Construtor") {
  ...
  Cliente comunicaBrasil(
    "Comunica Brasil", "comercial@comunicabrasil.com.br", "83974141",
    "856.478.566-55", PJ, 112548557
  );
  Login::logar(&agroBrasil);
  // Se um usuario estiver logado, qualquer tentativa de login ira retornar o
  // endereço da instancia daquele usuario
