...
int main() {
  ...
  // cargos da empresa
  std::vector<Cargo*> cargosEmpresa = { 
    new Cargo("Manutenção"),
    new Cargo("Vendedor"),
    new Cargo("Recrutamento")
  };
  empresa->setCargos(cargosEmpresa);

  // turnos da empresa
  std::vector<Turno*> turnosEmpresa = { 
    new Turno("Matutino", 8, 12, MANHA),
    new Turno("Vespertino Parcial", 12, 16, TARDE),
    new Turno("Vespertino Integral", 12, 20, TARDE),
    new Turno("Noturno", 18, 24, NOITE)
  };
  ...
  std::vector<Permissao*> todasPermissoes = 
    { perm1, perm2, perm3, perm4, perm5, perm6, perm7, perm8, perm9, perm10 };
  empresa -> setPermissoes(todasPermissoes);

  // uma vez criada a empresa, cria usuario com todas permissoes, exceto demitir funcionario
  Funcionario* user0 = new Funcionario(
    ...
    "Rua dos Bobos nº 0", 
    "202233665", 
    *empresa->getCargoByName("Vendedor"), 
    *empresa->getDepartamentoByName("Vendas"),
    Historico(Data(2022,9,29,15,59,00), "Contratação do 0"),
    Salario(1000.95,0, Data(2022,29,9,15,59,00), Gerencia),
    empresa->getTurnoByName("Vespertino Parcial")
  );
  std::vector<Permissao*> user0Permissions = 
    { perm1, perm2, perm3, perm5, perm6, perm7, perm8, perm9, perm10 };
  user0->setPermissoes(user0Permissions);
  ...
  Funcionario* user1 = new Funcionario(
    ...
    *empresa->getDepartamentoByName("Vendas"),
    ...
    Salario(1000.95,0, Data(2022,29,9,15,59,00), Gerencia),
    empresa->getTurnoByName("Matutino")
  );
  Funcionario* user2 = new Funcionario(
    ...
    "Rua dos Bobos nº 0", 
    "202233665", 
    *empresa->getCargoByName("Manutenção"), 
    *empresa->getDepartamentoByName("TI"),
    Historico(Data(2022,9,29,15,59,00), "Contratação do 2"),
    Salario(1000.95,0, Data(2022,29,9,15,59,00), Gerencia),
    empresa->getTurnoByName("Noturno")
  );
  Funcionario* user3 = new Funcionario(
    ...
    "Rua dos Bobos nº 0", 
    "202233665", 
    *empresa->getCargoByName("Recrutamento"), 
    *empresa->getDepartamentoByName("RH"),
    Historico(Data(2022,9,29,15,59,00), "Contratação do 3"),
    Salario(1000.95,0, Data(2022,29,9,15,59,00), Gerencia),
    empresa->getTurnoByName("Vespertino Integral")
  );
  ...
  // cadastrar 2 clieintes: PF e PJ
  Cliente* cliente0 = new Cliente(
    "Cliente 0", 
    "12525436604",
    "cliente0@testeemail.com",
    "senha123", 
    PF,
    9999999
  );
